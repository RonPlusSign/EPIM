<!--
This component is a data table that does CRUD requests of a resource.
...
Props:
- "items" (Array, required): the array of elements to work on
...
- "endpoint" (String, required): endpoint where to do the CRUD requests (for example "brands.php")
  (this component only does DELETE requests, see EAdminCRUDListDialog to see CREATE and PATCH requests)
...
<template>
  <v-container>
    <v-row cols="12" justify="center">
      <v-col xl="8" lg="8" md="8" sm="9" cols="12">
        <!------------------------>
        <!------ Data table ------>
        <!------------------------>
        <v-data-table
...
export default {
  name: "EAdminCRUDList",
  components: { EAdminCRUDListDialog },
  data: () => ({
